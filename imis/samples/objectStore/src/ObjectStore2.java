...
public class ObjectStore2
{
  ...
  private static void storeFileWithSpecifiedMime() throws StorageConnectorException, IOException
  {
    /*
    ...
    /*
     * Store object by specifying object's Content Type...
     * 
     ...
     */
    String objectId = storage.storeObject(mFileName, mProfile, mMime);
